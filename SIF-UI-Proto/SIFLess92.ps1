...
Import-Module SitecoreInstallFramework -RequiredVersion 2.0.0
        ...
        $Prefix = "sitecore9XMSIFLESS"
        $SitecoreAdminPassword = "b" #neverForget
        $SCInstallRoot = "D:\Sitecore9\9.1.0\XM"
        $SitecoreContentManagementSitename = "sitecore9XMSIFLESS.sc"
        $IdentityServerSiteName = "sitecore9XMSIFLESS.identityserver"
